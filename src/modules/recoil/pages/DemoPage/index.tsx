...
import { UserFilter, userFilter, userListSelector } from "@modules/recoil/models/user.model";
    ...
    return (
        <ContentLayout testId="DemoPage">
            <div className="row gap-4 gap-md-0">
                ...
                <div className="col-12 col-md-6">
                    <UserDetail id={id} isEdit={isEdit} handleOnModeChange={(isEdit) => setEdit(isEdit)} />
                </div>
            </div>
        </ContentLayout>
    );
