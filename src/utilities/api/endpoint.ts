 ...
 * @return {IApiTodo[]}
 */
export const fetchTodoList = async (): Promise<AxiosResponse<IApiTodo[], IBaseApiError>> => {
 ...
 * @return {IApiTodo}
 */
export const fetchTodoById = async (id: number): Promise<AxiosResponse<IApiTodo, IBaseApiError>> => {
 ...
 * @return {IApiUser[]}
 */
export const fetchUserList = async (): Promise<AxiosResponse<IApiUser[], IBaseApiError>> => {
 ...
 * @return
 */
export const fetchUserDetail = async (id: number): Promise<AxiosResponse<IApiUser, IBaseApiError>> => {
