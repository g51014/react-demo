    ...
    [
        ProductModule.Zustand,
        {
            ...
            children: [
                {
                    path: "demo",
                    component: React.lazy(() => import("@modules/zustand/pages/DemoPage")),
                },
            ],
        } as RouteConfig,
    ],
    [
        ProductModule.ReactQuery,
        {
            ...
            children: [
                {
                    path: "demo",
                    component: React.lazy(() => import("@modules/react-query/pages/DemoPage")),
                },
            ],
        } as RouteConfig,
    ],
...
export const NestRoute = (
    ...
    return [
        ...
        <Route
            key={currentPath}
            path={currentPath}
            element={Component ? <Component /> : <Navigate to="/404" state={{ from: location }} replace />}
        />,
    ];
};
