...
const Breadcrumb = forwardRef<HTMLDivElement>((prop: IBaseComponentProp, ref) => {
    ...
    return (
        ...
        >
            {breadcrumbs.map((breadcrumb, index) => {
                ...
                return (
                    <NavLink
                        className={`d-flex flex-row align-items-center text-gray-${isCurrentPage ? 1 : 2} text-gray-${
                            isCurrentPage ? 1 : 2
                        }--hover ${isCurrentPage ? "cursor-default" : ""}`}
                        key={breadcrumb}
